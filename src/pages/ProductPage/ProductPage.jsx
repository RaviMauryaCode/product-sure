...
const ProductPage = () => {
	...
	const [isCodeGenerateLoading, setIsCodeGenerateLoading] = useState(false);
	useEffect(() => {
	...
	const handleSubmit = async (e) => {
		...
		setIsCodeGenerateLoading(false);
	};
	...
	const draw = async (context, entry, height, width) => {
		...
		context.fillText(`₹${entry.productDetails.price}`, 300, 364);
				...
				<div className={styles.detailsBox}>
					...
					<div className={styles.genCodeContent}>
						...
						<div>
							...
							>
								{
									isCodeGenerateLoading ? <BeatLoader color="white" />
									: "Generate Codes"
								}
							</button>
						</div>
