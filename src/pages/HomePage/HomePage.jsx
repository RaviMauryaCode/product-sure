        ...
        <div className={styles.homePageContainer}>
            ...
            >
                ...
                <div className={styles.descSection}>
                    <span>
                        Building a secure & efficient solution
                        <br />
                        for Product Verification
                    </span>
                    <div className={styles.heroBtnContainer}>
                        <button
                            onClick={navigateToUserRegisterPage}
                            className={`${styles.registerBtn} ${styles.userBtn}`}
                        >
                            <PersonIcon className={styles.btnIcon} />
                            User
                        </button>
                        <button
                            onClick={navigateToCompanyRegisterPage}
            ...
            <div className={styles.infoContainer}>
                ...
                <div className={styles.infoCard}>
                    ...
                    <span>Indexing using The Graph</span>
                </div>
            </div>
        </div>
    );
